...
# Products Management Page - simplified
cat > /app/frontend/src/pages/admin/ProductsManagementPage.jsx << 'EOF'
...
cat > /app/frontend/src/pages/admin/CategoriesManagementPage.jsx << 'EOF'
import React, { useEffect, useState } from 'react'
import Header from '../../components/layout/Header'
import { Card } from '../../components/ui/card'
import { Button } from '../../components/ui/button'
...
echo "Created Products and Categories Management pages"
